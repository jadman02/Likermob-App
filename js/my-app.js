...
$$( '#resulty' ).append('<li class=".autocomplete_list"><div class="item-content"><div class="item-inner"><div class="item-input">' + response.predictions[i].place_id + ',' + response.predictions[i].description + '</div></div></div></li>');
