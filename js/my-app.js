...
$$( '#resulty' ).append('<li class="item-content"><div class="item-inner"><div class="item-title">' + response.predictions[i].place_id + ',' + response.predictions[i].description + '</div></div></li>');
