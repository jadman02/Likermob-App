...
$$( '#resulty' ).append('<li class="item-content"><div class="item-inner"><div class="item-title button" onclick="savePosition(\'hello\')">' + response.predictions[i].description + '</div></div></li>');
}
});    
