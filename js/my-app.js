...
$$( '#resulty' ).append('<li class="item-content"><div class="item-inner"><div class="item-title button" onclick="savePosition(5555)">' + response.predictions[i].description + '</div></div></li>');
}
});    
